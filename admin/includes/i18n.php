...
'ru' => [
  ...
  'csrf_bad'=>'Сессия истекла. Обновите страницу и попробуйте снова.','err_upload_big'=>'Загружаемые файлы слишком большие — превышен лимит сервера. Выберите меньше фото или уменьшите их размер.',
  ...
  't_hero_video'=>'Видео фон (Hero)','t_hero_video_h'=>'Ссылка на .mp4 или путь /assets/video/... Пусто — покажется изображение.',
  // projects / areas
  ...
  'ic_hotel'=>'Отель','ic_restaurant'=>'Ресторан','ic_education'=>'Образование','ic_medical'=>'Медицина','ic_business'=>'Бизнес-центр','ic_office'=>'Офис','ic_home'=>'Дом',
  'xp_sectors'=>'Сферы (с иконками)','xp_sectors_h'=>'Показываются иконками на странице «Услуги» и на главной.','xp_process'=>'Услуги (шаги процесса)','xp_process_h'=>'Нумерованный список этапов работы.','xp_row_hint'=>'Пустые строки не сохраняются.',
  // clients
  ...
  'ta_page'=>'Страница «О компании»','ta_lead'=>'Подзаголовок (под заголовком)','ta_intro'=>'Блок «Кто мы»','ta_stats'=>'Цифры (статистика)','ta_num'=>'Число','ta_label'=>'Подпись','ta_text'=>'Текст',
  'n_pages'=>'Страницы','pg_all'=>'Все страницы','pg_all_h'=>'Выберите страницу, чтобы отредактировать её тексты.','pg_col'=>'Страница','pg_saved'=>'Страница сохранена.','tr_note'=>'Вы редактируете перевод. Изображения и иконки берутся из основного языка (AZ).','pg_hero_title'=>'Заголовок страницы (H1)','pg_subtitle'=>'Подзаголовок','pg_image'=>'Изображение',
...
'en' => [
  ...
  'csrf_bad'=>'Your session expired. Refresh the page and try again.','err_upload_big'=>'The uploaded files are too large — the server limit was exceeded. Choose fewer photos or reduce their size.',
  ...
  't_hero_video'=>'Hero background video','t_hero_video_h'=>'A .mp4 link or /assets/video/... path. Empty — the image is shown.',
  ...
  'ic_hotel'=>'Hotel','ic_restaurant'=>'Restaurant','ic_education'=>'Education','ic_medical'=>'Medical','ic_business'=>'Business','ic_office'=>'Office','ic_home'=>'Home',
  ...
  'ta_page'=>'“About” page','ta_lead'=>'Subtitle (under the heading)','ta_intro'=>'“Who we are” block','ta_stats'=>'Stats (numbers)','ta_num'=>'Number','ta_label'=>'Caption','ta_text'=>'Text',
  'n_pages'=>'Pages','pg_all'=>'All pages','pg_all_h'=>'Pick a page to edit its texts.','pg_col'=>'Page','pg_saved'=>'Page saved.','tr_note'=>'You are editing a translation. Images and icons are taken from the base language (AZ).','pg_hero_title'=>'Page heading (H1)','pg_subtitle'=>'Subtitle','pg_image'=>'Image',
...
'az' => [
  ...
  'csrf_bad'=>'Sessiya bitib. Səhifəni yeniləyin və yenidən cəhd edin.','err_upload_big'=>'Yüklənən fayllar həddindən böyükdür — server limiti aşıldı. Daha az şəkil seçin və ya ölçüsünü kiçildin.',
  ...
  't_hero_video'=>'Hero video fonu','t_hero_video_h'=>'.mp4 keçidi və ya /assets/video/... yolu. Boş — şəkil göstərilir.',
  ...
  'ic_hotel'=>'Hotel','ic_restaurant'=>'Restoran','ic_education'=>'Təhsil','ic_medical'=>'Tibb','ic_business'=>'Biznes','ic_office'=>'Ofis','ic_home'=>'Ev',
  ...
  'ta_page'=>'“Şirkət haqqında” səhifəsi','ta_lead'=>'Alt başlıq (başlığın altında)','ta_intro'=>'“Kimik biz” bloku','ta_stats'=>'Rəqəmlər (statistika)','ta_num'=>'Rəqəm','ta_label'=>'Yazı','ta_text'=>'Mətn',
  'n_pages'=>'Səhifələr','pg_all'=>'Bütün səhifələr','pg_all_h'=>'Mətnlərini redaktə etmək üçün səhifə seçin.','pg_col'=>'Səhifə','pg_saved'=>'Səhifə saxlanıldı.','tr_note'=>'Tərcüməni redaktə edirsiniz. Şəkillər və ikonlar əsas dildən (AZ) götürülür.','pg_hero_title'=>'Səhifə başlığı (H1)','pg_subtitle'=>'Alt başlıq','pg_image'=>'Şəkil',

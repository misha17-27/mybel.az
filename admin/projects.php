          ...
          <div class="gal-grid">
            <?php foreach ($editing['gallery'] as $i => $g): ?>
              <div class="gal-item">
                ...
                <label for="galrm<?= $i ?>" class="gal-x" title="<?= e(t('p_remove')) ?>" aria-label="<?= e(t('p_remove')) ?>"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3.2" stroke-linecap="round" aria-hidden="true"><path d="M6 6l12 12M18 6L6 18"/></svg></label>
              </div>
            <?php endforeach; ?>
          </div>
        <?php endif; ?>

...
'az' => [
  ...
  'err_spam'=>'Spam aşkarlandı.','err_robot'=>'Zəhmət olmasa robot olmadığınızı təsdiqləyin.','err_ratelimit'=>'Çox sayda müraciət göndərilib. Bir saatdan sonra yenidən cəhd edin.','err_name'=>'Zəhmət olmasa ad sahəsini düzgün doldurun.','err_email'=>'Zəhmət olmasa düzgün e-poçt ünvanı daxil edin.','err_phone'=>'Telefon nömrəsi düzgün deyil.',
...
'ru' => [
  ...
  'err_spam'=>'Обнаружен спам.','err_robot'=>'Пожалуйста, подтвердите, что вы не робот.','err_ratelimit'=>'Отправлено слишком много заявок. Повторите попытку через час.','err_name'=>'Пожалуйста, корректно заполните поле имени.','err_email'=>'Пожалуйста, введите корректный адрес e-mail.','err_phone'=>'Некорректный номер телефона.',
...
'en' => [
  ...
  'err_spam'=>'Spam detected.','err_robot'=>'Please confirm you are not a robot.','err_ratelimit'=>'Too many requests. Please try again in an hour.','err_name'=>'Please fill in the name field correctly.','err_email'=>'Please enter a valid e-mail address.','err_phone'=>'Invalid phone number.',
